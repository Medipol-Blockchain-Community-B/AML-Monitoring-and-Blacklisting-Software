    ...
    <div name='pricing' className='w-full text-white my-24'>
      ...
      <div className='max-w-[1240px] mx-auto py-12'>
        ...
        <div className='text-center py-8 text-slate-300'>
          <h2 className='text-5xl font-bold text-center text-black'>Pricing</h2>
          <h3 className='text-3xl font-bold text-black py-8'>The right price for your research.</h3>
          <p className='text-3xl text-black text-slate-300'>
